...
export default function ProfitCalculator({
    ...
    return (
        <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md m-5">
            <h2 className="text-xl font-bold mb-4 text-blue-900">Calculadora de Beneficio Bruto</h2>
            <div className="mb-4">
                <label className="mb-2 font-medium text-gray-700">
                    Cantidad del ticket a invertir: <span className="font-bold text-blue-900">{formatEUR(investment)}</span>
                </label>
            ...
            <div className="mb-2">
                <ul className="mt-2 ml-4 list-disc text-gray-800">
                    <li>
                        <span className="font-semibold text-green-700">Mínimo beneficio bruto estimado:</span> {formatEUR(minProfit)}
                    </li>
                    <li>
                        <span className="font-semibold text-green-700">Máximo beneficio bruto estimado:</span> {formatEUR(maxProfit)}
                    </li>
                </ul>
            </div>
