...
export default async function HighVolumenSection({ highVolumens }: { highVolumens: IHighVolumen[] }) {
    return (
        <section className="w-full px-6 lg:px-16">
            <h2 className="text-3xl font-bold text-primary mb-6 text-center">
                Operaciones con descuento de gran volumen
            </h2>
            ...
            <div className="grid gap-8 lg:grid-cols-3 md:max-lg:px-16">
                {highVolumens.filter(op => op.starred).map(op => (
